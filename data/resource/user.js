...
function getUser(params, callback) {
    ...
    if (q == null)
        return callback(model.errors.e400);

    model.User.findOne(q, f, function (err, doc) {
        if (err) callback(model.errors.e503);
        else if (doc == null) callback(model.errors.e404);
...
function postUserQ(params, callback) {
    ...
    model.User.find(q, f, function (err, doc) {
        if (err) callback(model.errors.e503);
        else callback(doc);
    });
}
